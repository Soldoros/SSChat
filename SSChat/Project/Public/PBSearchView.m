...
-(void)setFriendString:(NSString *)friendString{
    ...
    if([friendString isEqualToString:userName]){
        _mButton.enabled = NO;
        [_mButton setTitle:@"这是本人" forState:UIControlStateNormal];
    ...
    else if ([contacts containsObject:friendString] || [blacks containsObject:friendString]) {
        _mButton.enabled = NO;
        [_mButton setTitle:@"已添加" forState:UIControlStateNormal];
        [_mButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateNormal];
        _mButton.layer.borderColor = [UIColor lightGrayColor].CGColor;
    }
    else if ([_invitedUsers containsObject:friendString]) {
        _mButton.enabled = NO;
        [_mButton setTitle:@"已申请" forState:UIControlStateNormal];
        [_mButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateNormal];
        _mButton.layer.borderColor = [UIColor lightGrayColor].CGColor;
    }else {
