...
- (void)viewDidLoad {
    ...
    _pageControll.currentPageIndicatorTintColor = TitleColor;
    ...
    for(int i=0;i<_images.count;++i){
        ...
        if(_frome == SSImageFromeUrl){
            NSString *imgString = [_images[i] imageString];
            [img setImageWithURL:[NSURL URLWithString:imgString] placeholder:[UIImage imageFromColor:BackGroundColor]];
        }
