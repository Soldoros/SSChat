...
-(instancetype)initWithFrame:(CGRect)frame{
    if(self = [super initWithFrame:frame]){
        ...
        _mButton1.tag = 100;
        [_mButton1 setImage:[UIImage imageNamed:@"liaotian_ic_biaoqing_nor"] forState:UIControlStateNormal];
        [_mButton1 setImage:[UIImage imageNamed:@"liaotian_ic_biaoqing_press"] forState:UIControlStateSelected];
        ...
        _mButton2.tag = 101;
        [_mButton2 setImage:[UIImage imageNamed:@"liaotian_ic_biaoqing_nor"] forState:UIControlStateNormal];
        [_mButton2 setImage:[UIImage imageNamed:@"liaotian_ic_biaoqing_press"] forState:UIControlStateSelected];
...
-(instancetype)initWithFrame:(CGRect)frame{
    if(self = [super initWithFrame:frame]){
        ...
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            [_emoticonImages addObjectsFromArray:_emotion.images];
            _defaultEmoticons = [_emotion dealWithArray:_emotion.images arr2:_emotion.systemImages];

            dispatch_async(dispatch_get_main_queue(), ^{
                [_collectionView reloadData];
                
                _numberPage = _defaultEmoticons.count/_number;
                _numberPage1 = _numberPage * _emotion.images.count/(_emotion.images.count + _emotion.systemImages.count);
                _numberPage2 = _numberPage-_numberPage1;
                _pageControl.numberOfPages = _numberPage1;
