...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if(self = [super initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:reuseIdentifier]){
        ...
        _mRightBtn.bounds = makeRect(0, 0, 15, 15);
        [self.contentView addSubview:_mRightBtn];
        _mRightBtn.right =  SSActionTableW - 15;
        _mRightBtn.centerY = SSActionCellH * 0.5;
        [_mRightBtn setImage:[UIImage imageNamed:@"wh_quxiaodindan_weixuanzhong"] forState:UIControlStateNormal];
        [_mRightBtn setImage:[UIImage imageNamed:@"wh_quxiaodindan_xuanzhong"] forState:UIControlStateSelected];
