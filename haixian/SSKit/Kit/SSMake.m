...
void makeUserToken(NSString *userToken){
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    [user setValue:userToken forKey:USER_Token];
}
//设备号
void makeUserDevice(NSString *userDevice){
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    [user setValue:userDevice forKey:USER_Device];
}
...
void makeUserKefu(NSString *userKefu){
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    [user setValue:userKefu forKey:USER_Kefu];
}
...
void makeUserCPName(NSString *cpName){
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    [user setValue:cpName forKey:USER_CPName];
}
//联系人
void makeUserCPPerson(NSString *cpPerson){
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    [user setValue:cpPerson forKey:USER_CPPerson];
}
//联系电话
void makeUserCPPhone(NSString *cpPhone){
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    [user setValue:cpPhone forKey:USER_CPPhone];
}
//所属行业
void makeUserCPIndustry(NSString *cpIndustry){
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    [user setValue:cpIndustry forKey:USER_CPIndustry];
}
//企业地址
void makeUserCPAddress(NSString *cpAddress){
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    [user setValue:cpAddress forKey:USER_CPAddress];
}
//详细地址
void makeUserCPDetAddress(NSString *DetAddress){
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    [user setValue:DetAddress forKey:USER_CPDetAddress];
}
...
void makeUserMemberType(NSString *memberType){
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    [user setValue:memberType forKey:USER_MemberTyp];
}
...
void makeUserIsSet(NSString *isSet){
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    [user setValue:isSet forKey:USER_IsSet];

}

//企业申请 1待审核 2审核不通过 3审核通过
void makeUserCpApproved(NSString *approved){
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    [user setValue:approved forKey:USER_CpApproved];
}
