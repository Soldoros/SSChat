...
@synthesizeAssociation(UIViewController,navtionBar);
@synthesizeAssociation(UIViewController,navtionImgView);
@synthesizeAssociation(UIViewController,navLine);


@synthesizeAssociation(UIViewController,titleLab);
@synthesizeAssociation(UIViewController,titleImgView);
@synthesizeAssociation(UIViewController,titleButton);

@synthesizeAssociation(UIViewController,leftBtn1);
@synthesizeAssociation(UIViewController,leftBtn2);
@synthesizeAssociation(UIViewController,rightBtn1);
@synthesizeAssociation(UIViewController,rightBtn2);
